...
def get_simulation_data(bearer_token_or_auth_file:str, 
    ...
    data_dict = {
        ...
        "historical_raw_power_eib": fil_stats_df["total_raw_power_eib"].values[:-1],
        "historical_qa_power_eib": fil_stats_df["total_qa_power_eib"].values[:-1],
        "historical_onboarded_qa_power_pib": fil_stats_df["day_onboarded_qa_power_pib"].values[:-1],
        "historical_renewed_qa_power_pib": fil_stats_df["day_renewed_qa_power_pib"].values[:-1],
